function Vmap( dom, mallId, floorId ) {
    ...
    function changeFloor( floorId ) {
       ...
       imgUrl = "http://123.57.46.160:8080/beacon/test!json?client=824&vkey=FFE58998-B203-B44E-A95B-8CA2D6CBCD65&floor="+floorId+"&place="+mallId+"&jsoncallback=?";
        /*imgUrl = "http://10.103.242.72:8888/beacon/test!json?client=824&vkey=FFE58998-B203-B44E-A95B-8CA2D6CBCD65&floor=Floor1&place=43C4DA8F-1D90-44DC-A0EC-A3ED452DB271&jsoncallback=?"*/
        $.getJSON( imgUrl,
                   function( result ) {
     ...
     function getUnitFont( uId, floorId,callback ) {
        ...
        $.getJSON(textUrl,
            ...
            for(var i in temp){
                ...
                //obj.minX = temp[i].coord_x*rate/currentScale*zoomScale - obj.length/2;
                //obj.maxX = temp[i].coord_x*rate/currentScale*zoomScale + obj.length/2;
                //obj.minY = temp[i].coord_y*rate/currentScale*zoomScale - 10;
                //obj.maxY = temp[i].coord_y*rate/currentScale*zoomScale + 10;
                //obj.midX = (obj.maxX+obj.minX)/2;
                //obj.midY = (obj.minY+obj.maxY)/2;
    ...
    function bindEvent() {
      ...
      /*  hammer.on("rotatestart rotatemove",function(ev){
            rotateStart(ev);
        });*/
